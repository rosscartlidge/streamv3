...
streamv3 read-csv large_file.csv | streamv3 limit 100 | \
...
streamv3 read-csv large.csv | streamv3 where ... | streamv3 limit 100
```
...
streamv3 read-csv huge.csv | streamv3 limit 100 | \
  streamv3 where ... | \
  streamv3 group ... | \
  jq '.'
```
