...
func main() {
	...
	sales := []streamv3.Record{
		...
		streamv3.MakeMutableRecord().String("region", "East").String("product", "Phone").Float("amount", 850).Freeze(),
		streamv3.MakeMutableRecord().String("region", "South").String("product", "Tablet").Float("amount", 450).Freeze(),
	}
